...
ActiveRecord::Schema[7.0].define(version: 2023_09_27_114825) do
  ...
  create_table "slot_bookings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["entrance_id"], name: "index_slot_bookings_on_entrance_id"
  ...
  create_table "slots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["entrance_id"], name: "index_slots_on_entrance_id"
  end
  ...
  add_foreign_key "slot_bookings", "entrances"
  add_foreign_key "slot_bookings", "slots"
  add_foreign_key "slot_bookings", "users"
  add_foreign_key "slots", "entrances"
end
